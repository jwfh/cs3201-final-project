...
times and still maintain accurate distance comparisons and fitness scores. 

After the final iteration of the GA, the true distance is calculated using
\eqref{eq:fit1}.
...
advantage of the computer's hardware. Initially, this resulted in {\em worse}
performance. Unfortunately, as QuantStart explains,
\begin{quote}
...
\subsection{Precomputing All Distances}
